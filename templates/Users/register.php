...
<img src="/img/uitemu-logo.png?v=1" alt="UiTEMU Logo" class="auth-logo">
            <h2>Join UiTEMU and Help Return Lost Items.</h2>
            <p>
                Create your account to report lost items, report found items,
                track claims, and receive reward certificates for your contribution.
            </p>
        </div>
